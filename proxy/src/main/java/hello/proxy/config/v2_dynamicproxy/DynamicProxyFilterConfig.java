...
import hello.proxy.app.v1.OrderContorllerV1Impl;
...
public class DynamicProxyFilterConfig {
	...
	private static final String[] PATTERNS = {"requset*", "order*", "save*"};

	@Bean
	public OrderControllerV1 orderControllerV1(LogTrace logTrace) {
		OrderControllerV1 orderControllerV1 = new OrderContorllerV1Impl(orderServiceV1(logTrace));
